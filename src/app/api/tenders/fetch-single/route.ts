...
function mapTender(row: Record<string, unknown>): Tender {
  return {
    ...
    bidStatus: (row.bid_status as Tender['bidStatus']) || null,
    bidStatusUpdatedAt: (row.bid_status_updated_at as string) || null,
    bidStatusUpdatedBy: (row.bid_status_updated_by as string) || null,
    ...
    l2Bidder: (row.l2_bidder as string) || null,
    l2Price: (row.l2_price as string) || null,
    l3Bidder: (row.l3_bidder as string) || null,
    l3Price: (row.l3_price as string) || null,
