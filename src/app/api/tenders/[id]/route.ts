...
export async function GET(
  ...
  try {
    ...
    const mapped: Tender = {
      ...
      l1ScopeOfWork: (tender.l1_scope_of_work as string) || null,
      l1AnalysisSource: (tender.l1_analysis_source as 'documents' | 'metadata_only') || 'metadata_only',
      ...
      bidStatus: (tender.bid_status as Tender['bidStatus']) || null,
      bidStatusUpdatedAt: (tender.bid_status_updated_at as string) || null,
      bidStatusUpdatedBy: (tender.bid_status_updated_by as string) || null,
      rejectedReason: (tender.rejected_reason as string) || null,
      ...
      l2Bidder: (tender.l2_bidder as string) || null,
      l2Price: (tender.l2_price as string) || null,
      l3Bidder: (tender.l3_bidder as string) || null,
      l3Price: (tender.l3_price as string) || null,
